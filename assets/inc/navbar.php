  ...
  <header id="header" class="fixed-top " style="background-color: black;">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar" style="margin-left: 40%;">
        <ul>
          <li><a class="nav-link scrollto active" style="color:white;" href="pass-dashboard.php">Dashboard</a></li>
          ...
          <li><a class="getstarted scrollto"  style="border-color: #aa39fa;" href="pass-logout.php">Log Out</a></li>
        </ul>
