          ...
          <div  style="margin-top:4%;">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-primary" style="border-color:#690191;">
                <div class="card-header card-header-divider" >Update User Profile<span style="   color:#e84362; " class="card-subtitle">Fill All
                    Details</span></div>
                <div class="card-body">
                  <form method="POST">
                    ...
                    <div class="parentDiv" style="border-radius: 100px;">
                      <div class="childDiv leftChild"
                        ...
                        <img src="../assets/images/update_profile.png" alt="Image" class="center" width="200" height="200"
                      ...
                      <div class="childDiv">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-12 col-sm-8 col-lg-6">
                            <input  required class="form-control" name="pass_email" value="<?php echo $row->user_email; ?>"
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-12 col-sm-8 col-lg-6">
                            <input required class="form-control" name="pass_phone" value="<?php echo $row->user_phone; ?>"
                              id="inputText3" type="text">
                          </div>
                        </div>
