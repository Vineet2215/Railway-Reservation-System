      ...
      <?php if (isset($succ)) { ?>
        ...
        <script>
          setTimeout(function() {
              ...
              .then(function() {
            window.location.href = 'emp-manage-train.php';
        })
            ...
            <div>
              <div>
                <div class="card card-border-color card-border-color-primary"  style="border-color:#690191;">
                  <div class="card-header card-header-divider" style="font-size: 40px; font-weight: bold;">Update Train<span class="card-subtitle"  style=" color:#e84362;">Please Fill All The Details</span></div>
                  <div class="card-body">
                      ...
                      <div class="parentDiv" style="border-radius: 100px;">
                        ...
                        <div class="childDiv">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                              <input  required class="form-control" name="fare" value="<?php echo $row->fare; ?>" id="inputText3" type="text">
                            </div>
                          </div>
