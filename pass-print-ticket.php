...
<body style="  background-color: #f8ebfc;">
  ...
  <div>
    ...
    <div>
       ...
       */
      $aid = $_SESSION['pass_id'];
      $ret = "select * from passenger where user_id=?"; 
...
$fare = $row->train_fare;
?>
                                    <p><b>Fare:</b> <?php echo  '<span id="sub3">' .$fare . '</span>'; ?></p>
                                  </div>
                                </div>
                                <hr>
                              </div>
            ...
            <br><br><br>
            <hr style="border:1.5px dashed #f5bac8; margin-top:100px;">
            <div class="row invoice-footer">
              <div class="col-lg-12" style="display:flex;justify-content:center ">
                <center>
                  <button style="margin-right:30px;"id="print" onclick="printContent('printReceipt');"
...
<script>
    ...
    btn.addEventListener('click',function(e){
        ...
        var body=' *********Ticket Information********'+'<br/> Name-'+name+ '<br/> Depart-'+sub1+ '<br/> Arrive-'+sub2+ '<br/> Fare-'+sub3+ '<br/> Train no-'+sub4+ '<br/> Train name-'+sub5+'<br/>************************************** ';
        Email.send({
